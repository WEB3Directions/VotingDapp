    ...
    {candidateList.length!==0?(<table className="candidate-list-table">
        <thead>
            <tr>
                ...
                <th className="candidate-list-table-header">Vote ID</th>
                <th className="candidate-list-table-header">Votes Received</th>
        ...
        <tbody>
            {candidateList.map((candidate, index) => (
                <tr key={index} className={index % 2 === 0 ? "even-row" : "odd-row"}>
                    ...
                    <td className="candidate-list-table-data">{String(candidate.candidateId)}</td>
